          ...
          <div class="sm:col-span-8 lg:col-span-7">
            ...
            <section aria-labelledby="options-heading" class="mt-10">
              ...
              <form>
                ...
                <button type="submit" class="mt-6 w-full bg-orange-600 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Get Now</button>
              </form>
            </section>
          </div>
        </div>
