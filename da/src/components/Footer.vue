  ...
  <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
    <div class="xl:grid xl:grid-cols-3 xl:gap-8">
      <div class="space-y-8 xl:col-span-1">
        <img class="h-10" src="../assets/logoMinimal.png" alt="Company name">
        <p class="text-gray-500 text-base">
          A better way to market your business
        </p>
        <div class="flex space-x-6">
          <a href="https://www.instagram.com/odesigns.tk/" class="text-gray-400 hover:text-gray-500">
          ...
          <a href="https://twitter.com/ODesignsStudios" class="text-gray-400 hover:text-gray-500">
        ...
        <div class="md:grid md:grid-cols-2 md:gap-8">
          <div>
            ...
            <ul role="list" class="mt-4 space-y-4">
              <li>
                <a href="websitesbyus" class="text-base text-gray-500 hover:text-gray-900">
                  Pre-made Websites
                </a>
              </li>
